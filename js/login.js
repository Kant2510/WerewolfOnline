...
var name = document.getElementById("name-box"), id = document.getElementById("id-box");

var btn_login = document.getElementById("button-login"), btn_admin = document.getElementById("button-admin");

var list_room_object = [], list_room_string = [];

var count_role = [], count_name = [];
